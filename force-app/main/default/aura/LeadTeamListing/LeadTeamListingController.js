({
    ...
    doAdd : function(component, event, helper) {
        ...
        var leadTeams = component.get("v.leadTeams");
        
        var newLeadTeam ='{"sobjectType": "Lead_Team__c"}';
                            
    	var newLeadTeamParsed = JSON.parse(newLeadTeam);      
        
        leadTeams.push(newLeadTeamParsed);
        
        component.set("v.leadTeams", leadTeams);
    ...
    removeDeletedRow: function(component, event, helper) {
        ...
        var AllRowsList = component.get("v.leadTeams");
        AllRowsList.splice(index, 1);
        // set the contactList after remove selected row element  
        component.set("v.leadTeams", AllRowsList);
    }, 
