({
	doInit : function(component, event, helper) {
        ...
        helper.getOrderContactRoles(component, event);
    },
    
    
    doAdd : function(component, event, helper) {
        
        var orderContactRoles = component.get("v.recordEditRecords");
        var newOrderContactRole ='{"sobjectType": "Order_Contact_Role__c"}';
        var newrojectContactRolParsed = JSON.parse(newOrderContactRole);
        
        orderContactRoles.push(newrojectContactRolParsed);
        
        component.set("v.recordEditRecords", orderContactRoles);
        console.log("orderContactRoles "+orderContactRoles);
    ...
    searchField : function(component, event, helper) {
        ...
        //var orderContactRoles = component.get("v.orderContactRoles");
        res.forEach(function(v,i) {
            if(IdField[i].get("v.value") != null){
                ...
                orderContactRole.ContactName__c = ContactNameField[i].get("v.value");
                orderContactRole.AccountName__c = AccountNameField[i].get("v.value");
        ...
        console.log('orderContactRoles '+orderContactRoles);
        component.set("v.searchRecords",orderContactRoles);
    ...
    Back : function(component,event,helper){
        ...
        evt.setParams({
            componentDef: "c:AddOrderContactRoles",
            componentAttributes: {
