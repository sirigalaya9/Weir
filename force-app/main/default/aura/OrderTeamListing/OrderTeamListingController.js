({
    ...
    doAdd : function(component, event, helper) {
        ...
        var OrderTeams = component.get("v.OrderTeams");
        
        var newOrderTeam ='{"sobjectType": "Order_Team__c"}';
                            
    	var newOrderTeamParsed = JSON.parse(newOrderTeam);      
        
        OrderTeams.push(newOrderTeamParsed);
        
        component.set("v.OrderTeams", OrderTeams);
        console.log("OrderTeams "+OrderTeams);
    ...
    removeDeletedRow: function(component, event, helper) {
        ...
        var AllRowsList = component.get("v.OrderTeams");
        AllRowsList.splice(index, 1);
        // set the contactList after remove selected row element  
        component.set("v.OrderTeams", AllRowsList);
    }, 
